const { default: makeWASocket, BufferJSON, MessageType, MessageOptions, Mimetype, generateWAMessageFromContent, downloadContentFromMessage, proto } = require('@whiskeysockets/baileys')
...
exports.smsg = (conn, m, hasParent) => {
    ...
    if (m.msg.url) m.download = () => downloadMediaMessage(m)
